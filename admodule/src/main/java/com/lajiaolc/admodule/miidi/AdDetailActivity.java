...
public class AdDetailActivity extends Activity implements /*IAdWallRequestAdSourceNotifier*/ IAdWallRequestAdSourceSigninNotifier {
...
//		AdWall.requestAdSource(this);
		AdWall.requestAdSourceSignin(this);
	...
	public View showAdDetail(final AdDesc adInfo){
    	try {
    		...
    		if(adInfo != null){
				...
				View view = View.inflate(this, R.layout.miidi_detail, null);
